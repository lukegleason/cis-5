...
int main(int argc, char** argv) {
    ...
    do { //Do-while loop to repeat until user provides proper input
        ...
        if (choice == "PLAYER1" || choice == "PLAYER2"){
            ...
            //If user input invalid repsonse, then send them a message
            //to inform them on the correct repsonse.
    ...
    while (totalP1 > 0 && totalP2 > 0){
        ...
        if(totalP1>0){          //If player 1 has more than 0 points.
            cout<<endl<<"Congrats! Player 1 won!"<<endl;
        } else if (totalP2>0) { //If player 2 has more than 0 points.
            cout<<endl<<"Congrats! Player 2 won!"<<endl;
        }
